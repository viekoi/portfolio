        ...
        <div className="relative md:col-span-1  col-span-2 flex w-full flex-col items-center justify-center rounded-2xl  rounded-br-2xl  border  border-solid   border-dark bg-light p-6  shadow-2xl dark:border-light dark:bg-dark">
            ...
            <div className="w-full">
                ...
                <div className="mt-4 flex w-full flex-col items-start justify-between">
                    ...
                    <Link target='_blank' href={pageUrl} rel='noreferrer' className='rounded text-lg font-medium underline md:text-base '>visit</Link>
                    <Link href={codeUrl} target='_blank' rel='noreferrer'><div className='rounded-full shadow-lg shadow-gray-400 p-3 cursor-pointer hover:scale-105 ease-in duration-300 dark:bg-white dark:text-dark '>
                    <FaGithub />
                  </div></Link>
                    </div>
                </div>
